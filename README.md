...
You must have the [Node JS](https://nodejs.org/en) installed on your computer.

# How to install

Before proceeding, it is necessary to install the project dependencies, open the console of your choice and type:
...
If you are interested and want to know more about docz, just click [here](https://www.docz.site).